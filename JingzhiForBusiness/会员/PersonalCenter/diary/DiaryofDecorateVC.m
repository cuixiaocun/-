...
@interface DiaryofDecorateVC ()<IsTureAlterViewDelegate,DiaryDecrateDelegate>

@end

@implementation DiaryofDecorateVC
...
- (void)viewDidLoad {
    ...
    withDrawlsBtn.frame = CGRectMake(CXCWidth-80, 20, 64, 44);
...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    DiaryDecrateCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[DiaryDecrateCell alloc] initWithStyle:UITableViewCellStyleDefault
...
//            NSLog(@"");
        ...
        {
            NSLog(@"看文章");
            DiaryDetailListVC *viewController =[[DiaryDetailListVC alloc]init];
