...
//    levelLabel.text =[NSString stringWithFormat:@"%@",IsNilString([dic objectForKey:@"name"])?@"":[dic objectForKey:@"name"]];
    ...
    NSArray *topArr =@[@"me_icon_sjs",@"me_icon_mall",@"me_icon_rj",@"me_icon_quit",@"vip_wo_icon_qrcode",@"vip_wo_icon_pwd",@"vip_wo_icon_true",@"vip_wo_icon_exit",@"proxy_me_icon_huiyuan",@"proxy_me_icon_ka",@"proxy_me_icon_fan",@"proxy_me_icon_shen",@"proxy_me_icon_shou",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",];
    
    NSArray*bottomArr =@[@"设计师管理",@"商城订单",@"装修日记",@"退出登录",@"",] ;
    for (int i=0; i<4; i++) {
        //大按钮
        ...
        if (i==0) {
            ...
            btn.frame =CGRectMake(0,100*Width*i+bgImageV.bottom+60*Width,CXCWidth,100*Width);
        }
