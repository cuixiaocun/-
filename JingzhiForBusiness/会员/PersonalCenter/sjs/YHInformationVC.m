...
@interface YHInformationVC ()

@end

@implementation YHInformationVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    YHInformationCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[YHInformationCell alloc] initWithStyle:UITableViewCellStyleDefault
