...
#import "MyToubiaoCell.h"
@interface MyToubiaoVC ()

@end

@implementation MyToubiaoVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MyToubiaoCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[MyToubiaoCell alloc] initWithStyle:UITableViewCellStyleDefault
