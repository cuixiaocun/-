...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([typeStr isEqualToString:@"220"])
    {
        ...
        TenderDetailCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
        if (cell == nil) {
            cell = [[TenderDetailCell alloc] initWithStyle:UITableViewCellStyleDefault
    ...
    }else if([typeStr isEqualToString:@"221"])
    {
        NSInteger row =[indexPath row];
        static NSString *CellIdentifier = @"Cell22";
        BiddingCompanyCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
        if (cell == nil) {
            cell = [[BiddingCompanyCell alloc] initWithStyle:UITableViewCellStyleDefault
                                           reuseIdentifier:CellIdentifier ];
            [cell setSelectionStyle:UITableViewCellSelectionStyleNone];
        }
        return cell;
