...
@interface IWantToubiao ()
@end

@implementation IWantToubiao
...
//    NSString *str = [NSString stringWithFormat:@"%@",[infoArray[indexPath.row] objectForKey:@"content"]];
    NSString *str = [NSString stringWithFormat:@"%@",@"高新区恒大名都新房简装，预算大约4万以内qqq山东点点滴滴"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ToubiaoCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[ToubiaoCell alloc] initWithStyle:UITableViewCellStyleDefault
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ToubiaoDetailVC *toubiao =[[ToubiaoDetailVC alloc]init];
