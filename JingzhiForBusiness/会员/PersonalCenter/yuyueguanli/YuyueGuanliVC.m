...
#import "YuyueGuanliCell.h"
#import "ChuliYuyueDetailVC.h"
@interface YuyueGuanliVC ()

@end

@implementation YuyueGuanliVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    YuyueGuanliCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[YuyueGuanliCell alloc] initWithStyle:UITableViewCellStyleDefault
...
{
    ChuliYuyueDetailVC *toubiao =[[ChuliYuyueDetailVC alloc]init];
