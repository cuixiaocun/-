...
- (void)mainView
{
    ...
    [self.tableView setFrame:CGRectMake(0,Frame_NavAndStatus+20*Width, CXCWidth, CXCHeight-Frame_rectStatus)];
...
- (void)getInfoList
{
    ...
    [PublicMethod AFNetworkPOSTurl:@"Home/Member/moneyLog" paraments:dic1  addView:self.view addNavgationController:self.navigationController success:^(id responseDic) {
