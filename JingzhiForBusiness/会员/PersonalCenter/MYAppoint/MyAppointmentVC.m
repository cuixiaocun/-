...
#import "MyAppointmentThreeCell.h"
...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([typeStr isEqualToString:@"220"])
    {
        ...
        MyAppointmentCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
        if (cell == nil) {
            cell = [[MyAppointmentCell alloc] initWithStyle:UITableViewCellStyleDefault
    ...
    }else if([typeStr isEqualToString:@"221"])
    {
        ...
        MyAppointmentTwoCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
        if (cell == nil) {
            cell = [[MyAppointmentTwoCell alloc] initWithStyle:UITableViewCellStyleDefault
                                            reuseIdentifier:CellIdentifier ];
            [cell setSelectionStyle:UITableViewCellSelectionStyleNone];
    ...
    else
    {
        ...
        MyAppointmentThreeCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
        if (cell == nil) {
            cell = [[MyAppointmentThreeCell alloc] initWithStyle:UITableViewCellStyleDefault
                                            reuseIdentifier:CellIdentifier ];
            [cell setSelectionStyle:UITableViewCellSelectionStyleNone];
