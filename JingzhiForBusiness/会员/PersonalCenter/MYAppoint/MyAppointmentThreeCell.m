...
@implementation MyAppointmentThreeCell
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        NSArray*leftArr =@[@"半小时前",@"ID",@"商铺",@"商品",@"联系人",@"联系电话",@"",@"",@"",@"",];
        
        NSArray*rightArr =@[@"",@"18949589534293",@"北京九华",@"热水器",@"张山",@"13929392572",@"3",@"",@"",];
        for (int i=0; i<6; i++){
            //背景
