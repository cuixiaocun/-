...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    YHQCell*cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[YHQCell alloc] initWithStyle:UITableViewCellStyleDefault
...
- (void)getInfoList
{
    ...
    [PublicMethod AFNetworkPOSTurl:@"mobileapi/?product-coupon.html" paraments:dic1  addView:self.view addNavgationController:self.navigationController success:^(id responseDic) {
        ...
        if ([ [NSString stringWithFormat:@"%@",[dict objectForKey:@"error"]]isEqualToString:@"0"]) {
            NSMutableArray *array=[NSMutableArray arrayWithArray:[[dict objectForKey:@"data"] objectForKey:@"item"]];
