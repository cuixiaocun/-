...
+ (instancetype)tx_label {
    ...
    label.textColor = [UIColor colorWithRed:249/255.0 green:98/255.0 blue:48/255.0 alpha:1];
...
- (void)setSomePreference {
    /** Default preference. */
    self.backgroundColor = [UIColor colorWithRed:253/255.0 green:239/255.0 blue:212/255.0 alpha:1];
