...
@property (nonatomic, weak) UIScrollView *actionSheet;
...
+ (instancetype)sr_actionSheetViewWithTitle:(NSString *)title cancelTitle:(NSString *)cancelTitle destructiveTitle:(NSString *)destructiveTitle withNumber:(NSString*)number withLineNumber:(NSString*)lineNumber otherTitles:(NSArray *)otherTitles otherImages:(NSArray *)otherImages selectActionBlock:(SRActionSheetDidSelectActionBlock)selectActionBlock {
    
    return [[self alloc] initWithTitle:title cancelTitle:cancelTitle destructiveTitle:destructiveTitle withNumber:number withLineNumber:lineNumber otherTitles:otherTitles otherImages:otherImages selectActionBlock:selectActionBlock];
}

- (instancetype)initWithTitle:(NSString *)title cancelTitle:(NSString *)cancelTitle destructiveTitle:(NSString *)destructiveTitle withNumber:(NSString*)number withLineNumber:(NSString*)lineNumber otherTitles:(NSArray *)otherTitles otherImages:(NSArray *)otherImages selectActionBlock:(SRActionSheetDidSelectActionBlock)selectActionBlock {
...
+ (instancetype)sr_actionSheetViewWithTitle:(NSString *)title cancelTitle:(NSString *)cancelTitle destructiveTitle:(NSString *)destructiveTitle withNumber:(NSString*)number withLineNumber:(NSString*)lineNumber otherTitles:(NSArray *)otherTitles otherImages:(NSArray *)otherImages delegate:(id<SRActionSheetDelegate>)delegate {
    
    
    return [[self alloc] initWithTitle:title cancelTitle:cancelTitle destructiveTitle:destructiveTitle withNumber:number withLineNumber:lineNumber otherTitles:otherTitles otherImages:otherImages delegate:delegate];
}

- (instancetype)initWithTitle:(NSString *)title cancelTitle:(NSString *)cancelTitle destructiveTitle:(NSString *)destructiveTitle withNumber:(NSString*)number withLineNumber:(NSString*)lineNumber otherTitles:(NSArray *)otherTitles otherImages:(NSArray *)otherImages delegate:(id<SRActionSheetDelegate>)delegate {
...
- (void)setupActionSheet {
    ...
    [self addSubview:({
        UIScrollView *actionSheet = [[UIScrollView alloc] init];
        actionSheet.backgroundColor = kActionSheetColor;
        _actionSheet = actionSheet;
    })];
    [_actionSheet setUserInteractionEnabled:YES];
    [_actionSheet setContentSize:CGSizeMake(CXCWidth, (kActionItemHeight*[_number integerValue]+[_lineNumber integerValue]*kDividerHeight)+12.5)];
    NSLog(@"%f--%f--%ld--%ld-%f",kActionItemHeight,kDividerHeight,[_lineNumber integerValue],(long)[_number integerValue],(kActionItemHeight*[_number integerValue]+[_lineNumber integerValue]*kDividerHeight));
    _offsetY = 0;
    ...
    if((kActionItemHeight*[_number floatValue]+[_lineNumber floatValue]*kDividerHeight)>CXCHeight)
    {
        _actionSheet.frame = CGRectMake(0, 64, CXCWidth, CXCHeight-64);
        _actionSheet.showsVerticalScrollIndicator =
        NO;
    }else
    {
