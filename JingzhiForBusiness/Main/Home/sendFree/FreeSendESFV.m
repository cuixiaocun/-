...
- (void)mainView
{
    ...
    topView =[[UIView alloc]initWithFrame:CGRectMake(0, 0, CXCWidth,1370*Width )];
    topView.backgroundColor =BGColor;
    [self addSubview:topView];
    
    NSArray*leftArr =@[@"市/区",@"类型",@"价格",@"小区名称",@"简称",@"售价",@"地址",@"房屋类型",@"联系人",@"联系电话",@"开发商",@"",@"",@"",@"",@"",@"",@"",] ;
    NSArray*rightArr =@[@"选择市/区",@"选择类型",@"选择价格",@"输入小区名称",@"输入简称",@"输入售价",@"输入地址",@"输入房屋类型",@"输入房屋类型",@"输入联系人姓名",@"输入开发商名称",@"",@"",@"",] ;
    ...
    UIView*contentV =[[UIView alloc]initWithFrame:CGRectMake(0*Width,1100*Width+60*Width, CXCWidth, 210*Width)];
    [topView addSubview:contentV];
    contentV.backgroundColor =[UIColor whiteColor];
    //活动内容
    self.contentTextView = [[UITextView alloc] initWithFrame:CGRectMake(25*Width,1100*Width+60*Width, 700*Width, 210*Width)];
