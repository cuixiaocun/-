...
@interface FreeSendLPV :TPKeyboardAvoidingScrollView <UITextFieldDelegate,UITextViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,ZHPickViewDelegate>
{
    UITextField *titleTF;
    UILabel *xqlabel;
    UIButton *upLoadBtn;
