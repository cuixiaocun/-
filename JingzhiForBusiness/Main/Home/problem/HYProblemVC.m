...
@interface HYProblemVC ()

@end

@implementation HYProblemVC
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)getProblem
{
    [PublicMethod AFNetworkPOSTurl:@"Home/Index/question" paraments:@{}  addView:self.view  addNavgationController:self.navigationController success:^(id responseDic) {
