...
@interface FindCompanyVC ()<MenuChooseDelegate,UITextFieldDelegate ,FindCompanyDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    FindCompanyCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[FindCompanyCell alloc] initWithStyle:UITableViewCellStyleDefault
...
{
     FindCompanyDetailVC*find =[[FindCompanyDetailVC alloc]init];
