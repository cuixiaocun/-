...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        //案例
        _caseLabel =[[UILabel alloc]initWithFrame:CGRectMake(_phoneImageV.right+24*Width, _nameLabel.bottom,200*Width, 50*Width)];
        _caseLabel.numberOfLines =0;
        _caseLabel.text =@"案例：30套";
        _caseLabel.font =[UIFont systemFontOfSize:13];
        _caseLabel.textColor =TextColor;
        [self addSubview:_caseLabel];
        
        //案例
        _qdsLabel =[[UILabel alloc]initWithFrame:CGRectMake(_caseLabel.right+24*Width, _nameLabel.bottom,200*Width, 50*Width)];
        _qdsLabel.numberOfLines =0;
        _qdsLabel.text =@"签单：30单";
        _qdsLabel.font =[UIFont systemFontOfSize:13];
        _qdsLabel.textColor =TextColor;
        [self addSubview:_qdsLabel];
        
        //毕业院校
        _appiontLabel =[[UILabel alloc]initWithFrame:CGRectMake(_phoneImageV.right+24*Width,_caseLabel.bottom, 500*Width, 50*Width)];
        _appiontLabel.text =@"预约数：0人";
        _appiontLabel.font =[UIFont systemFontOfSize:13];
        _appiontLabel.textColor =TextColor;
        [self addSubview:_appiontLabel];
        //面积
        _addressLabel =[[UILabel alloc]initWithFrame:CGRectMake(_phoneImageV.right+24*Width, _appiontLabel.bottom, 500*Width, 50*Width)];
        _addressLabel.text =@"地址：山东省潍坊市奎文区1111号中天下潍坊国际 ";
