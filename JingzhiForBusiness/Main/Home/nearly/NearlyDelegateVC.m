...
- (void)getInfoList
{
    ...
    NSLog(@"%@",dic1);
    [PublicMethod AFNetworkPOSTurl:@"Home/Index/nearbyagent" paraments:dic1  addView:self.view  addNavgationController:self.navigationController success:^(id responseDic) {
