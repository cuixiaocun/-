...
//{
//    //底部scrollview
//    bgScrollView =[[UIScrollView alloc] initWithFrame:CGRectMake(0, 44+Frame_Y, 320, UI_SCREEN_HEIGHT-44-Frame_Y-49)];
//    [bgScrollView setUserInteractionEnabled:YES];
//    //    [bgScrollView setContentSize:CGSizeMake(320, 225+197+60+182+146+207+500+418)];
//    [bgScrollView setShowsVerticalScrollIndicator:NO];
//    [self.view addSubview:bgScrollView];
//    [bgScrollView setContentSize:CGSizeMake(320, 570)];
//
//    //顶部广告图
//
//    cycleScrollView2 =[SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 0, 320, 140) delegate:self placeholderImage:[UIImage imageNamed:@"placeholder@2x"]];
...
//        [gnBtn setFrame:CGRectMake(80*(i%4), i<4?146:(146+93), 79.5, 92.5)];
