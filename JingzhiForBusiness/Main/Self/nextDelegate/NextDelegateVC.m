...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NextDelegateCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[NextDelegateCell alloc] initWithStyle:UITableViewCellStyleDefault
...
- (void)getInfoList
{
    ...
    [dic1 setDictionary:@{
                          @"relation":[NSString stringWithFormat:@"%@",[[PublicMethod getDataKey:agen] objectForKey:@"relation"]],
                          }
     ];
    
    [PublicMethod AFNetworkPOSTurl:@"home/AgentOnlineorder/getallagent" paraments:dic1  addView:self.view success:^(id responseDic) {
