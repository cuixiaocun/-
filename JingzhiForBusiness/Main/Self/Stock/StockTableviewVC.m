...
@implementation StockTableviewVC
...
- (void)mainView
{
    ...
    [goBtn setFrame:CGRectMake(40*Width,20*Width , 670*Width, 88*Width)];
    [goBtn setBackgroundColor:NavColor];
    [goBtn.layer setCornerRadius:4];
    [goBtn.layer setMasksToBounds:YES];
    
    [goBtn setTitle:@"去下单" forState:UIControlStateNormal];
    [goBtn.titleLabel setTextColor:[UIColor whiteColor]];
    [goBtn.titleLabel setFont:[UIFont boldSystemFontOfSize:18]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        cell = [[StockCell alloc] initWithStyle:UITableViewCellStyleDefault
