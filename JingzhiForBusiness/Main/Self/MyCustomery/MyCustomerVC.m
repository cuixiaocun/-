...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MyCustomerCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[MyCustomerCell alloc] initWithStyle:UITableViewCellStyleDefault
...
//                          @"uid":[NSString stringWithFormat:@"%@",[[PublicMethod getDataKey:agen] objectForKey:@"id"]]
    ...
    [PublicMethod AFNetworkPOSTurl:@"home/Agen/myCustomer" paraments:dic1  addView:self.view success:^(id responseDic) {
