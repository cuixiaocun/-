...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    WithDrawlsCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[WithDrawlsCell alloc] initWithStyle:UITableViewCellStyleDefault
...
- (void)getInfoList
{
    ...
    [PublicMethod AFNetworkPOSTurl:@"home/Account/record" paraments:dic1  addView:self.view success:^(id responseDic) {
