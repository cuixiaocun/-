...
//    bankLabel.text =@"6223 9103 0116 0170";
    ...
    UILabel *tishiLabel =[[UILabel alloc]initWithFrame:CGRectMake(imgV.right, bgview.bottom , 350*Width, 64*Width)];
    ...
    [nextBtn setFrame:CGRectMake(40*Width,bgview.bottom+ 106*Width , 670*Width, 88*Width)];
