...
@interface OrderCirclatonVC ()

@end

@implementation OrderCirclatonVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    OrderCirCell *cell =[tableView1 dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[OrderCirCell alloc] initWithStyle:UITableViewCellStyleDefault
